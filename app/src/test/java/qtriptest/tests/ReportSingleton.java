...
public class ReportSingleton {
    ...
    private ReportSingleton() {
       ...
       // report = new ExtentReports("/home/crio-user/workspace/sunnyhith-avadootha4-ME_QTRIP_QA_V2/app" + "/OurExtentReport" + timestampString + ".html");

       report = new ExtentReports("/home/crio-user/workspace/sunnyhith-avadootha4-ME_QTRIP_QA_V2/app/src/test/java/qtriptest/Reports" + "/OurExtentReport" + timestampString + ".html");
